...
COMMENT ON COLUMN public.addresses.zip IS 'Postal or zip code part of the address';
...
COMMENT ON COLUMN public.manufacturers.name IS 'The name of the manufacturer';
...
COMMENT ON COLUMN public.manufacturers.address_id IS 'The address of the manufacturer';
...
COMMENT ON COLUMN public.widget_statuses.name IS 'The name of the widget status';
...
COMMENT ON COLUMN public.widgets.name IS 'The name of the widget';
...
COMMENT ON COLUMN public.widgets.price_cents IS 'The price of the widget in cents';
...
COMMENT ON COLUMN public.widgets.manufacturer_id IS 'The maker of the widget';
...
COMMENT ON INDEX public.index_api_keys_on_client_name IS 'We need to be able to find keys by client';
...
COMMENT ON INDEX public.index_api_keys_on_key IS 'API keys have to be unique or we don''t who is accessing us';
...
--
-- Name: INDEX index_manufacturers_on_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON INDEX public.index_manufacturers_on_name IS 'No two manufacturers should have the same name';
...
COMMENT ON INDEX public.index_widgets_on_name_and_manufacturer_id IS 'No manufacturer should have two widgets with the same name';
